#!/usr/bin/env python3
"""Generate Jigsaw Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\Jigsaw")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "jigsaw"
TEST = APP / "src" / "test" / "java" / "com" / "jigsaw"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "jigsaw"
...
android {
    namespace = "com.jigsaw"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.jigsaw.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.jigsaw.data.** { *; }
-keep class com.jigsaw.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "jigsaw-game",
    "storage_bucket": "jigsaw-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.jigsaw.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating Jigsaw project files...")
