...
1. Open `D:\Work\Games\Jigsaw` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `JigsawEngine.kt` (tube pour logic) and update the game board UI component.
